					...
					<div class="info clearfix">
						<form class="form-inline">
							...
							<div class="row" id="payfeeLpk" style="border-bottom: 1px solid #CCC; display: none;">
								...
								<div class="form-group col-xs-12">
									<table id="threeOrderPayfeeCardList"></table>
								</div>
							</div>
							<br>
	...
	<script type="text/javascript">
				...
				success:function(data){
					if (data.msg =="00") {
						...
						$.each(data.list,function(i,v){
							html +="<tr>";
							html +="<td><input type='radio' name='threeOrderPayfeeCardNum' value='"+v.cardNumb+"'>"+v.cardNumb+"</td>";
		...
		function saveThreeOrderPayfee() {
			...
			var params = {
				...
				feeToDate : feeToDate,
				feeSumYhzz : feeSumYhzz,
				postBankYhzz : postBankYhzz,
				bankFlowNumYhzz : bankFlowNumYhzz,
				postUserYhzz : postUserYhzz,
				feeSumPos : feeSumPos,
				bankFlowNumPos : bankFlowNumPos,
				postNumPos : postNumPos,
				feeSumRhPos : feeSumRhPos,
				postTerminalNoRhPos : postTerminalNoRhPos,
				bankFlowNumRhPos : bankFlowNumRhPos,
				feeSumLpk : feeSumLpk,
				cardNum : cardNum,
				feeSumOther : feeSumOther,
				collectionEntity : collectionEntity,
				postUserOther : postUserOther,
				feePosts : feePosts
			}
