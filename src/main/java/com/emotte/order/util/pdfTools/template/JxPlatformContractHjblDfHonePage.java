...
public class JxPlatformContractHjblDfHonePage extends BaseTemplate {
	...
	public JxPlatformContractHjblDfHonePage(File pdf, JxPlatformContractRevisedDFModel model, String filePath,
			Integer preview) {
		super(pdf);
		try {
