...
public class Order extends BaseModel {
	...
	// 商品订单需求
	private List listItem;// 多个商品的集合

	private List listInterview; // 服务订单匹配人员信息
	...
	// 不包括的订单编号
	private String orderCodeNotIn;
	//唯品会订单id
	private String vphOrderId;
	//结算单id
	...
	//提前发服务人员服务费状态显示
	private String salaryStatusText;
	private int isNewFF;//是否新分发流程1：是 2：否
	private Integer type;
	private Integer isShow;//前端是否展示(null或1：显示 2:不显示) 默认为显示
	private Long recommendUserId;//推荐人
	private Integer orderPushType;//推单类型:1,代下单,2分享订单(与推荐人的合伙人id一起使用)
	private String cancelText;//订单取消原因
	private String solutionCode;
	
	
	private String serviceObject;//服务对象  (1  企业   2  个人)

	private String startLinedTime;//排期起始时间

	private String endLinedTime;//排期结束时间

	private Integer checkStatus;//单次合同审核状态
	...
	/**
	 *	 	 
	 * 订单状态: 1 新建,  2已受理, 3匹配中,4已匹配, 5待面试, 6面试成功, 7已签约, 8已上户, 9已完成, 10已取消, 11已下户,12已终止,
     *          13捡货中, 14配送中 16 三方订单匹配失败          17工作完成,
     *          18,待受理（其中分别为，商品：1 新建,2已受理,13捡货中,14配送中,9已完成,10已取消,18,待受理  单次：1新建,2已受理,3匹配中,4已匹配,8已上户,9已完成,10已取消,18,待受理
     *          20撤销     
     *     延续：1 新建,2已受理,3匹配中, 5待面试, 6面试成功, 7已签约, 8已上户, 9已完成, 10已取消,11已下户,12已终止 ，20撤销）
	 * 
	 * : order_status
	 * 
	 * @return
	...
	public List getListInterview() {
		return listInterview;
	}

	public void setListInterview(List listInterview) {
	...
	public String getOrderCodeNotIn() {
		return orderCodeNotIn;
	}

	public void setOrderCodeNotIn(String orderCodeNotIn) {
		this.orderCodeNotIn = orderCodeNotIn;
	}
	...
	public String getSalaryStatusText() {
		return salaryStatusText;
	}

	public void setSalaryStatusText(String salaryStatusText) {
		this.salaryStatusText = salaryStatusText;
	}

	public int getIsNewFF() {
		return isNewFF;
	}

	public void setIsNewFF(int isNewFF) {
		this.isNewFF = isNewFF;
	}
	...
	public Integer getOrderPushType() {
		return orderPushType;
	}

	public void setOrderPushType(Integer orderPushType) {
	...
	public String getStartLinedTime() {
		return startLinedTime;
	}

	public void setStartLinedTime(String startLinedTime) {
		this.startLinedTime = startLinedTime;
	}

	public String getEndLinedTime() {
		return endLinedTime;
	}

	public void setEndLinedTime(String endLinedTime) {
		this.endLinedTime = endLinedTime;
	}
